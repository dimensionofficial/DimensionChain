...
## eonio.system::cfgproducer    account config
...
## eonio.system::okproducer     account producer vote
...
## eonio.system::setproxy       account proxy
...
## eonio.system::unstake        account quantity 
...
## eonio.system::withdraw account
   - this action can only be triggered by eonio.system via a deferred transaction generated by unstake
   - this will generate an inline eonio.token::transfer call from=eonio.system to=account and amount equal to the next withdraw increment
   - this will generate another deferred withdraw to continue the process if there are still withdraws to be made


## eonio.system::transfer from to amount memo
   - decrements balance of from if amount <= balance
   - increments balance of to by amount
   - memo is ignored 

## eonio.system::stakevote account amount
   - the primary currency of eonio is controlled by the token contract which enables users to transfer
...
## eonio.system::onblock   account blocktime blocknum
...
## eonio.system::freeze producer accounts true|false 
...
## eonio.system::paystandby producer

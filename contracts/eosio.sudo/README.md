...
```
$ cleon system newaccount -s -j -d --transfer --stake-net "1.000 EON" --stake-cpu "1.000 EON" --buy-ram-kbytes 50 eonio eonio.sudo EONMMUW11TAdTDxqdSwSqJodefSoZbFhcprndomgLi9MeR2o8MT4 > generated_account_creation_trx.json

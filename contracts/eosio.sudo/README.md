...
```
$ cleos system newaccount -s -j -d --transfer --stake-net "1.000 EON" --stake-cpu "1.000 EON" --buy-ram-kbytes 50 eosio eosio.sudo EOS8MMUW11TAdTDxqdSwSqJodefSoZbFhcprndomgLi9MeR2o8MT4 > generated_account_creation_trx.json

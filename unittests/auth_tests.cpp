...
BOOST_AUTO_TEST_CASE(link_auths) { try {
   ...
   // Link authority for eonio reqauth action with alice's spending key
   ...
   // Unlink alice with eonio reqauth
   ...
   // Link authority for any eonio action with alice's scud key

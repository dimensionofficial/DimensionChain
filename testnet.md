...
Before getting into the details of the Dimension testnet, lets clarify some terms. In this document I use the terms "host" and "machine" fairly interchangeably. A host generally boils down to a single IP address, although in practice it could have more.
...
#### Star network
![](https://github.com/dimensionofficial/dimension/raw/master/star.png)
...
#### Mesh network
![](https://github.com/dimensionofficial/dimension/raw/master/mesh.png)
...
```
  "nodes": [[
      "testnet_0",{
        ...
        "ssh_identity": "",
        "ssh_args": "",
        "eon_root_dir": "/home/phil/blockchain/eon",
        "data_dir": "tn_data_0",
        "hostname": "remoteserv",
...
| eon_root_dir       | specifies the directory into which all eosd artifacts are based. This is required for any hosts that are not the local host.

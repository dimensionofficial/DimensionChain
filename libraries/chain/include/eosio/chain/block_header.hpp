...
namespace eosio { namespace chain {
   ...
   struct block_header
   {
      ...
      static fc::optional<producer_schedule_change_extension> get_new_producer_schedule(const flat_multimap<uint16_t, block_header_extension>& exts);
      static fc::optional<protocol_feature_activation> get_new_protocol_feature_activation(const flat_multimap<uint16_t, block_header_extension>& exts);
   };

...
namespace eosio { namespace chain { namespace wasm_constraints {
   ...
   constexpr unsigned maximum_mutable_globals    = 1024*1024;        //bytes
   constexpr unsigned maximum_table_elements     = 1024*1024;        //elements
   constexpr unsigned maximum_section_elements   = 1024*1024;        //elements
   constexpr unsigned maximum_linear_memory_init = 64*1024*1024;     //bytes
   constexpr unsigned maximum_func_local_bytes   = 8192 * 1024;        //bytes

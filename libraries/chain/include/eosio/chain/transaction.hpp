...
namespace eosio { namespace chain {
   ...
   struct transaction : public transaction_header {
      ...
      static fc::optional<deferred_transaction_generation_context> get_deferred_transaction_generation_context(const flat_multimap<uint16_t, transaction_extension>& exts);
   };
